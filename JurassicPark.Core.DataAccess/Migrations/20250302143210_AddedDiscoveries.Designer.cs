...
namespace JurassicPark.Core.Migrations
{
    ...
    [Migration("20250302143210_AddedDiscoveries")]
    partial class AddedDiscoveries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JurassicPark.Core.DataAccess.DataSchemas.Discovered", b =>
                {
            ...
            modelBuilder.Entity("JurassicPark.Core.DataAccess.DataSchemas.Discovered", b =>
                {
                    b.HasOne("JurassicPark.Core.DataAccess.DataSchemas.Animal", "Animal")
                        .WithMany("DiscoveredMapObjects")
                        .HasForeignKey("AnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JurassicPark.Core.DataAccess.DataSchemas.MapObject", "MapObject")
